...
db = psycopg2.connect(host="ec2-34-197-84-74.compute-1.amazonaws.com",user="amiojqvfvmtsov",password="bb77a35cd66023c87c5df1a76620ffa2a74d685d5e746bc02ac65971a838a666",database="d5tvomseano6lc")
cur = db.cursor()
